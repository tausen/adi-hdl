...
create_bd_port -dir I -from 3 -to 0 adc_data
...
ad_connect adc_clk ad7771_adc_pack/clk
ad_connect sys_rstgen/peripheral_reset ad7771_adc_pack/reset
ad_connect axi_ad7771/adc_valid_pp ad7771_adc_pack/fifo_wr_en

for {set i 0} {$i < 3} {incr i} {
  ad_connect axi_ad7771/adc_data_$i ad7771_adc_pack/fifo_wr_data_$i
}
...
ad_connect  adc_clk axi_ad7771_adc/clk_in
