...
set_property  -dict {PACKAGE_PIN L18  IOSTANDARD LVCMOS25}  [get_ports clk_in]              ; #DCLK_B   
set_property  -dict {PACKAGE_PIN M19  IOSTANDARD LVCMOS25}  [get_ports ready_in]            ; #DRDY_B
set_property  -dict {PACKAGE_PIN M20  IOSTANDARD LVCMOS25}  [get_ports data_in[0]]          ; #DOUT0_B   
set_property  -dict {PACKAGE_PIN L22  IOSTANDARD LVCMOS25}  [get_ports data_in[1]]          ; #DOUT1_B   
set_property  -dict {PACKAGE_PIN P17  IOSTANDARD LVCMOS25}  [get_ports data_in[2]]          ; #DOUT2_B   
set_property  -dict {PACKAGE_PIN P18  IOSTANDARD LVCMOS25}  [get_ports data_in[3]]          ; #DOUT3_B   
