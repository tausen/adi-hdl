...
set_property -dict {PACKAGE_PIN J20    IOSTANDARD LVCMOS25              } [get_ports adc_or_in]           ; #G18  FMC_LPC_LA16_P
...
set_input_delay -clock adc_clk_adaq -max  $rise_max  [get_ports adc_or_in];                       
set_input_delay -clock adc_clk_adaq -min  $rise_min  [get_ports adc_or_in];                       
set_input_delay -clock adc_clk_adaq -max  $fall_max  [get_ports adc_or_in] -clock_fall -add_delay;
set_input_delay -clock adc_clk_adaq -min  $fall_min  [get_ports adc_or_in] -clock_fall -add_delay; 