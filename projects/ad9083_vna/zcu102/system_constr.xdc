...
set_property  -quiet -dict {PACKAGE_PIN  J4}                 [get_ports rx_data_p[1]]      ; ## A2  FMC_HPC0_DP1_M2C_P
set_property  -quiet -dict {PACKAGE_PIN  J3}                 [get_ports rx_data_n[1]]      ; ## A3  FMC_HPC0_DP1_M2C_N
set_property  -quiet -dict {PACKAGE_PIN  F2}                 [get_ports rx_data_p[2]]      ; ## A6  FMC_HPC0_DP2_M2C_P
set_property  -quiet -dict {PACKAGE_PIN  F1}                 [get_ports rx_data_n[2]]      ; ## A7  FMC_HPC0_DP2_M2C_N
set_property  -quiet -dict {PACKAGE_PIN  K2}                 [get_ports rx_data_p[3]]      ; ## A10 FMC_HPC0_DP3_M2C_P
set_property  -quiet -dict {PACKAGE_PIN  K1}                 [get_ports rx_data_n[3]]      ; ## A11 FMC_HPC0_DP3_M2C_N
...
set_property  -dict {PACKAGE_PIN  Y2  IOSTANDARD LVCMOS18}   [get_ports refsel]            ; ## G9  FMC_HPC0_LA03_P
...
set_property  -dict {PACKAGE_PIN  AB6  IOSTANDARD LVCMOS18} [get_ports adl5960_temp_1]     ; ## H16 FMC_HPC0_LA11_P
set_property  -dict {PACKAGE_PIN  AB5  IOSTANDARD LVCMOS18} [get_ports adl5960_temp_2]     ; ## H17 FMC_HPC0_LA11_N
set_property  -dict {PACKAGE_PIN  Y10  IOSTANDARD LVCMOS18} [get_ports adl5960_temp_3]     ; ## H19 FMC_HPC0_LA15_P
set_property  -dict {PACKAGE_PIN  Y9   IOSTANDARD LVCMOS18} [get_ports adl5960_temp_4]     ; ## H20 FMC_HPC0_LA15_N
set_property  -dict {PACKAGE_PIN  L13  IOSTANDARD LVCMOS18} [get_ports adl5960_temp_5]     ; ## H22 FMC_HPC0_LA19_P
...
set_property  -dict {PULLTYPE PULLUP} [get_ports adl5960_temp_3]
set_property  -dict {PULLTYPE PULLUP} [get_ports adl5960_temp_4]
set_property  -dict {PULLTYPE PULLUP} [get_ports adl5960_temp_5]
set_property  -dict {PULLTYPE PULLUP} [get_ports adl5960_temp_6]
set_property  -dict {PULLTYPE PULLUP} [get_ports adl5960_temp_7]
set_property  -dict {PULLTYPE PULLUP} [get_ports adl5960_temp_8]
set_property  -dict {PULLTYPE PULLUP} [get_ports adl5960_temp_8]
...
set_property  -dict {PACKAGE_PIN  AA12 IOSTANDARD LVCMOS18} [get_ports spi_bus0_csn_f1]    ; ## G19 FMC_HPC0_LA16_N
